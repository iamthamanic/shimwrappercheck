...
export const PROJECT_RULES_CATALOG: CatalogRule[] = [
  {
    ...
    category: "both",
    form: { type: "max_lines", maxLines: 300 } as Omit<ProjectRuleForm, "id">,
  },
  {
    id: "no_hardcoded_hex",
    ...
    category: "frontend",
    form: { type: "forbidden_regex", pattern: "#[0-9a-fA-F]{3,8}\\b" } as Omit<ProjectRuleForm, "id">,
  },
  {
    ...
    category: "frontend",
    form: { type: "forbidden_regex", pattern: "\\b(rgb|rgba|hsl|hsla)\\s*\\(" } as Omit<ProjectRuleForm, "id">,
  },
  {
    id: "no_inline_styles",
    ...
    category: "frontend",
    form: { type: "forbidden_regex", pattern: "style=\\{\\{" } as Omit<ProjectRuleForm, "id">,
  },
  {
    ...
    category: "frontend",
    form: { type: "forbidden_regex", pattern: "(text|bg|border)-\\[#" } as Omit<ProjectRuleForm, "id">,
  },
  {
    ...
    category: "both",
    form: { type: "forbidden_regex", pattern: "from\\s+['\"]\\.\\./\\.\\./" } as Omit<ProjectRuleForm, "id">,
  },
  {
    id: "no_console_log",
    ...
    category: "backend",
    form: { type: "forbidden_regex", pattern: "console\\.(log|error|warn)\\s*\\(" } as Omit<ProjectRuleForm, "id">,
  },
  {
    id: "no_any_type",
    ...
    category: "both",
    form: { type: "forbidden_regex", pattern: "(:\\s*any\\b|as\\s+any\\b)" } as Omit<ProjectRuleForm, "id">,
  },
];
