import { CONFIG_KEY_ORDER, DEFAULT_CHECK_CATALOG, } from "./schema.js";
...
export function configToLegacyRc(config) {
    const values = {};
    ...
    values.SHIM_EXPLANATION_MIN_RATING = String(config.explanationCheck.minRating);
...
export function formatLegacyRcFile(values, headerLine = "# shimwrappercheck config (managed by shimwrappercheck)") {
...
//# sourceMappingURL=write-legacy-rc.js.map